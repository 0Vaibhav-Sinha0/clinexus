...
# Routes low-confidence signals to human review queue.
# Rejections feed back into procedural memory for continuous learning.
##############################################################################
...
class HITLGate:
    ...
    async def process_human_decision(
        ...
        Approve or edit moves signal to approved status.
        Reject moves signal to rejected status and updates procedural memory.
        """
