...
#
# Evaluates sponsor credibility based on their complete history of
# behaviour across all clinical trials in the database.
##############################################################################
...
async def track_record_node(state: MosaicState) -> dict:
    """Evaluates sponsor credibility based on complete history."""
    ...
    try:
        ...
        system_prompt = f"""You are the Track Record Agent for Clinexus.
