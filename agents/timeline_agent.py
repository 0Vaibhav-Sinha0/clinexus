...
#
# Detects studies significantly delayed past their completion date
# without filing an explanation.
##############################################################################
...
async def timeline_node(state: MosaicState) -> dict:
    """Detects silent delays in clinical trials."""
    ...
    try:
        ...
        system_prompt = f"""You are the Timeline Analyst Agent for Clinexus.
