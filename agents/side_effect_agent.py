...
#
# Compares official trial safety reports against published research
# to detect discrepancies in safety reporting.
##############################################################################
...
async def side_effect_node(state: MosaicState) -> dict:
    """Finds safety gaps between official filings and published papers."""
    ...
    try:
        ...
        system_prompt = f"""You are the Side Effect Checker Agent for Clinexus.
