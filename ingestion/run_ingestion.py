...
#
# Main entry point for the ingestion pipeline. Orchestrates all other
# modules (clinical_trials_client, pubmed_client, document_parser,
# gcs_store) to download and process studies and papers end-to-end.
#
# Run from terminal:
...
async def run_ingestion():
    ...
    logger.info("=" * 60)
    logger.info("Starting Clinexus ingestion pipeline")
